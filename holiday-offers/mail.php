...
$dest = $_POST['dest'];
$id=rand(10,10000);
foreach ($_POST['dest'] as $selected_dest) {
    $des=$selected_dest;
} 
$adults=$_POST["adults"];
$kids=$_POST["kids"];
                ...
                <tr>
                  <td>
                    ...
                    <tr><td style='font-size:1.2em;color:#136ad5;font-family:Century Gothic;'>Phone :- $mob </td></tr>
                      ...
                      <tr><td style='font-size:1.2em;color:#136ad5;font-family:Century Gothic;'>Destinations :- $des</td></tr>
                     <tr><td style='font-size:1.2em;color:#136ad5;font-family:Century Gothic;'>Adults :- $adults </td></tr>
                     <tr><td style='font-size:1.2em;color:#136ad5;font-family:Century Gothic;'>No. of Days :- $days </td></tr>
                     <tr><td style='font-size:1.2em;color:#136ad5;font-family:Century Gothic;'>Date :- $date </td></tr>
                    </table>
                  </td>
                </tr>
