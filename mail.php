...
$con=new clscon();
$link=$con->db_connect();
$qry1="insert into tb_query(name,c_code,phone,email,msg) values ('$name','$c_code','$phone','$email','$msg')";
$res1=  mysqli_query($link,$qry1);
$qid=mysqli_insert_id($link);
$to = "sunil@myflighttrip.com";
$subject = "Thanks for contacting Indiator-QRY10".$qid;
$subjects= "Query regarding Tours- QRY10".$qid;
$message = "<html>";
$message .= "<head>\r\n";
   ...
   <tr bgcolor='FFFFFF'>
                ...
                <tr>
                  <td>
                    ...
                    <tr><td style='font-size:1.2em;color:#136ad5;font-family:Century Gothic;'>Phone :- $c_code $phone </td></tr>
                     ...
                     <tr><td style='font-size:1.2em;color:#136ad5;font-family:Century Gothic;'>Query regarding City :- $l </td></tr>
