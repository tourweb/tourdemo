...
//nav tab
add_shortcode( 'lefttab', 'easyweb_webnus_navtabgroup' );
function easyweb_webnus_navtabgroup( $atts, $content ){
	$GLOBALS['tab_count'] = 0;
...
add_shortcode( 'ltab', 'easyweb_webnus_ntabs' );
function easyweb_webnus_ntabs( $atts, $content ){
