...
function  easyweb_webnus_bloxdark_shortcode($attributes, $content)
{
...
add_shortcode("bloxdark", 'easyweb_webnus_bloxdark_shortcode');




function  easyweb_webnus_blox_shortcode($attributes, $content)
{
...
add_shortcode("blox", 'easyweb_webnus_blox_shortcode');