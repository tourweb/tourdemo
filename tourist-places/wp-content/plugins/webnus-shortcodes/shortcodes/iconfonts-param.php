...
function easyweb_webnus_icomoon_composer($settings, $value) {
   ...
   $out .= '<div id="retinaicon-form" class="webnus-iconfonts-wrapper">
	...
	<div class="webnus-icons-list-wrapper">
		...
		<li><input type="radio" name="iconfonts_name" id="icon-facebook" value="icon-facebook"><label for="icon-facebook"><i class="icon-facebook"></i></label></li>
		<li><input type="radio" name="iconfonts_name" id="icon-twitter" value="icon-twitter"><label for="icon-twitter"><i class="icon-twitter"></i></label></li>
		...
		<li><input type="radio" name="iconfonts_name" id="icon-linkedin" value="icon-linkedin"><label for="icon-linkedin"><i class="icon-linkedin"></i></label></li>
