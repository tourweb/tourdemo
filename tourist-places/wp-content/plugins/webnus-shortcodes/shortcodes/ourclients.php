...
function easyweb_webnus_ourclients($attributes, $content){
...
add_shortcode("ourclients", "easyweb_webnus_ourclients");
function easyweb_webnus_client($attributes, $content){
	extract(shortcode_atts(array(
		"img" => '',
		"img_alt" => '',
	), $attributes));
...
add_shortcode("client", "easyweb_webnus_client");
?>