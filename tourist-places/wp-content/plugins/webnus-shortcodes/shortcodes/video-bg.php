<?php 
function  easyweb_webnus_videorow_shortcode($attributes, $content) {
	...
	if ( $video_src == 'host' ) :
		...
		$out .= esc_html__('Your browser does not support the video tag. I suggest you upgrade your browser.','easyweb_webnus_framework');
		$out .= '</video><div style="position: absolute; top: 0; right: 0; bottom: 0; left: 0; background-position: 50% 50%; background-repeat: no-repeat; background-size: auto 100%; background: transparent url(' . $img_preview_video . ') 50% 50% / cover no-repeat ;"></div>';
...
add_shortcode("videorow", 'easyweb_webnus_videorow_shortcode');
?>