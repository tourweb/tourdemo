						...
						<div class="toggle">
							<div class="mm-panel-alert">
								<p>
									...
									<?php esc_html_e('Universal Analytics will be the default setting in an future version of this plugin.', 'gap'); ?>
								</p>
								<ul>
					...
					<div id="mm-panel-overview" class="postbox">
						...
						<div class="toggle">
							<div class="mm-panel-overview">
								<p><?php esc_html_e('Welcome!', 'gap'); ?> <?php echo $gap_plugin; ?> <?php esc_html_e('adds the GA Tracking Code to your WordPress pages.', 'gap'); ?></p>
								<ul>
								...
								<p>
									...
									<a target="_blank" href="http://wordpress.org/support/view/plugin-reviews/<?php echo basename(dirname(__FILE__)); ?>?rate=5#postform" title="<?php esc_attr_e('THANK YOU for your support!', 'gap'); ?>">
