...
class Easyweb_Webnus_PopularPosts extends WP_Widget{
	function __construct(){
	$params = array('description'=> 'Display Popular Posts','name'=> 'Webnus-Popular Posts');
	parent::__construct('Easyweb_Webnus_PopularPosts', '', $params);
	}
...
add_action('widgets_init', 'register_easyweb_webnus_PopularPosts');
function register_easyweb_webnus_PopularPosts(){
	register_widget('Easyweb_Webnus_PopularPosts');
}