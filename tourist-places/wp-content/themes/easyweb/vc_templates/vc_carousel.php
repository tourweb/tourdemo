...
<div class="<?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base'], $atts ) ?>">
	<div class="wpb_wrapper">
		...
		<div id="<?php echo esc_attr( $carousel_id ) ?>" data-ride="vc_carousel"
			 data-wrap="<?php echo esc_attr( $wrap === 'yes' ? 'true' : 'false' ) ?>"
			 data-interval="<?php echo esc_attr( $autoplay == 'yes' ? $speed : 0 ) ?>" data-auto-height="true"
			 data-mode="<?php echo esc_attr( $mode ) ?>" data-partial="<?php echo esc_attr( $partial_view === 'yes' ? 'true' : 'false' ) ?>"
			 data-per-view="<?php echo esc_attr( $slides_per_view ) ?>"
			 data-hide-on-end="<?php echo esc_attr( $autoplay == 'yes' ? 'false' : 'true' ) ?>" class="vc_carousel vc_slide">
