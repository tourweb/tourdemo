...
$officialname=$_POST["officialname"];
  ...
  $con=new clscon();
  $link=$con->db_connect();
  $query="insert into affiliate(companyname,officialname,businesstype,firstname,lastname,position,email,phonenumber,faxnumber,website,country,state,city,address) values ('$companyname','$officialname','$businesstype','$firstname','$lastname','$position','$email','$phonenumber','$faxnumber','$website','$country','$state','$city','$address')";
...
$subjects = "Indiator- New Affiliate Details AFF10".$pid;
$message = "<html>";
$message .= "<head>\r\n";
                  ...
                  <td>
                    <table  width='700' align='justify' cellpadding='2' cellspacing='3' class='container-middle'>
                      ...
                      <tr style='background-color:#DE5420;'>
                        <td style='font-size:2em;color:white;font-family:Century Gothic;'><b>New Affiliate Details </b></td>
                      </tr>
                        <tr>
                        <td style='font-size:1.1em;color:#4f90fe;font-family:Century Gothic;'>Affiliate ID: AFF10 $pid<span style='color:black;'>$tour_code </span></td>
                      </tr>
                       <tr>
