                ...
                <?php } 
				   ...
				   <article class="blog-help">
                    ...
                    <div class="help-txt">
                        ...
                        <p class="help-phone"><i class="fa fa-phone"></i> 1-964-324-34</p>
                    </div>
                </article>
			   
            </div>
            <?php if(isset($_POST["btncat"]))
            { ?>
            ...
            <div class="main-switcher">
				...
				<div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
					...
					<ul id="Grid" class="sandbox">
                        ...
                        $con=new clscon();
                        $link=$con->db_connect();
                        $qry11="SELECT tour_id,substring(tour_name,1,70) tour_name,substring(short_description,1,105) short_description from tb_tours where tour_cat_id IN (".implode(",",$s).") and tour_city_id=$cid";
                       ...
                       $cs=0;
						...
						<li class="mix category-3" data-value="1250">
							<figure>
								...
								<figcaption>
                                    <h3><?php echo $arr11[$cs][1];?></h3><br>
                                    
                                    <p><?php echo $arr11[$cs][2];?></p>
                                    ...
                                    <a href="tour-details.php?tid=<?php echo $arr11[$cs][0];?>" class="btn btn-primary btn-gallery">Read More</a>
                                </figcaption>
							</figure>
						</li>
                        <?php 
            ...
            <div class="main-switcher">
                ...
                <div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
                    ...
                    <ul id="Grid" class="sandbox">
                        ...
                        $obj= new clstour();
                        $a=$obj->display_rec($cityid,$catid);
                        $c=count($a);
                            ...
                            <figure>
                                <div class="cbp-vm-image img">
                                    <?php
                                      ...
                                      $con=new clscon();
                                      $link=$con->db_connect();
                                      $qry4="select img1 from tb_images where tour_id=".$a[$i][0];
                                      $res4=  mysqli_query($link, $qry4);
                                      $ar1=array();
                                      $y=0;
                                      while ($r4=  mysqli_fetch_row($res4))
                                    ...
                                    <img src="indiator_admin/uploads/<?php echo $ar1[0][0]; }?>" alt=""/>
                                    <div class="overlay">
                                        <a href="tour-details.php?tid=<?php echo $a[$i][0];?>" class="expand">+</a>
                                        <a class="close-overlay hidden">x</a>
                                    </div>
                                    </div>
                                
                                <figcaption>
                                    <h3><?php echo $a[$i][2];?></h3><br>
                                    ...
                                    <div class="price-night"><span>Price starts from</span>
                                         <?php
                                          ...
                                          $con=new clscon();
                                          $link=$con->db_connect();
                                          $qry3="select price8 from tb_price where tour_id=".$tourid;
                                          $res3=  mysqli_query($link, $qry3);
                                          $ar=array();
                                          $x=0;
                                          while ($r3=  mysqli_fetch_row($res3))
                                        ...
                                        <span class="price-n"><?php echo "$ ".$ar[0][0]; } ?></span></div>   
                                    <a href="tour-details.php?tid=<?php echo $a[$i][0];?>" class="btn btn-primary btn-gallery">Read More</a>
                                </figcaption>
                            </figure>
                        </li>
                        <?php 
