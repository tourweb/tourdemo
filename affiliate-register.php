...
<html>
<head>
    <title>Affiliate Register - Indiator</title>
    <meta charset="utf-8">
          ...
          <div class="row">
             <div class="col-md-12">
               <div class="page-title pull-left">
                    <h2 class="title-about">Affiliate Registartion</h2>
                </div>
...
<section id="top-info-contact" style="padding: 23px 0;">
   <div class="container">
      ...
      <div class="help-txt"> 
        ...
        <form id="form-sign-up" action="affiliatemail.php" method="post">
    <div class="col-md-4">
      <div class="form-group col-md-12">
          <input type="text"  name="companyname" value="" placeholder="Company Name" class="form-control" required />
      </div>
      <div class="form-group col-md-12">
      ...
      <div class="form-group col-md-12">
            <input type="text" name="firstname" value="" placeholder="Contact Person First Name" class="form-control" required />
      </div>
      <div class="form-group col-md-12">
          <input type="text" name="lastname" value="" placeholder="Contact Person Last Name" class="form-control"  />
      </div>
      <div class="form-group col-md-12">   
    ...
    <div class="col-md-4">
        <div class="form-group col-md-12">
          <input type="text" name="phonenumber" value="" placeholder="Phone Number" class="form-control" required />
      </div>
    <div class="form-group col-md-12">
      ...
      <div class="form-group col-md-12">
          <input type="text" name="country" value="" placeholder="Country" class="form-control" required />
      </div>
      <div class="form-group col-md-12">
          <input type="text" name="state" value="" placeholder="State"  class="form-control" required />
      </div>
       <div class="form-group col-md-12">
          <input type="text" name="city" value="" placeholder="City"  class="form-control" required />
      </div>
      <div class="form-group col-md-12">
    ...
    <div class="col-md-4">
      ...
      <div class="form-group col-md-12">
          <input type="password"  name="password2" value="" placeholder="Confirm Password" class="form-control" required />
