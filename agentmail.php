...
include("indiator_admin/buslogic.php");
 $agencyname=$_POST["agencyname"];
  ...
  $con=new clscon();
  $link=$con->db_connect();
  $query="insert into agent(agencyname,companyname,agencytype,firstname,lastname,position,email,phonenumber,faxnumber,website,country,state,city,address,username,password) values ('$agencyname','$companyname','$agencytype','$fname','$lname','$position','$email','$phonenumber','$faxnumber','$website','$country','$state','$city','$address','$username','$password')";
...
$subject = "Thanks for becoming an affiliate- Indiator";
$subjects = "Indiator- New Affiliate Details AGN10".$pid;
$message = "<html>";
$message .= "<head>\r\n";
                  ...
                  <td>
                    <table  width='700' align='justify' cellpadding='2' cellspacing='3' class='container-middle'>
                      ...
                      <tr style='background-color:#DE5420;'>
                        <td style='font-size:2em;color:white;font-family:Century Gothic;'><b>New Agent Details </b></td>
                      </tr>
                        <tr>
                        <td style='font-size:1.1em;color:#4f90fe;font-family:Century Gothic;'>Agent ID: AGN10 $pid<span style='color:black;'>$tour_code </span></td>
                      </tr>
                       <tr>
                        <td style='font-size:1.1em;color:#4f90fe;font-family:Century Gothic;'>Agency Name:<span style='color:black;'> $agencyname</span></td>
                      </tr>
                      <tr>
                        <td style='font-size:1.1em;color:#4f90fe;font-family:Century Gothic;'>Company Name: <span style='color:black;'>$companyname </span></td>
                      </tr>
                           <tr>
                        <td style='font-size:1.1em;color:#4f90fe;font-family:Century Gothic;'>Agency Type: <span style='color:black;'>$agencytype</span></td>
                      </tr>
                           <tr>
